...
| Changed                                                                | Reconcile                                                                                                                                                                                                                           |
| ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Hard rule / command / package count in `AGENTS.md`                     | `.github/copilot-instructions.md` (inlines rules + count), the relevant file under `docs/conventions/`                                                                                                                              |
| A package's `exports` / subpaths / `tsdown` entries / directives       | `packages/<pkg>/AGENTS.md`, the canonical **`packages/<pkg>/README.md`** (Exports + Usage + "For AI agents"), then `pnpm gen:llms`, `docs/guides/contributing.md`, `docs/conventions/` (`docs/packages/<pkg>.md` is just a pointer) |
